    ...
    while True:
        try:
            ...
            if choice > len(options) or choice < 1:
                raise ValueError
            print(f"User selected option number: {choice}")  # Debug print
